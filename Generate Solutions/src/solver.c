...
int main(int argc, char **argv)
{
    ...
    if (cross)
    {
        ...
        for (int i = 0; cross[i] != '\0'; ++i)
        {
            if (cross[i] == '\n')
            {
                cross[i] = ' '; // Replace newline with space
            }
        }
    ...
    if (f2l)
    {
        ...
        for (int i = 0; f2l[i] != '\0'; ++i)
        {
            if ((f2l[i] == '\n') || (f2l[i] == ')') || (f2l[i] == '('))
            {
                f2l[i] = ' '; // Replace newline with space
            }
        }
    ...
    if (oll)
    {
        ...
        for (int i = 0; oll[i] != '\0'; ++i)
        {
            if ((oll[i] == '\n') || (oll[i] == ')') || (oll[i] == '('))
            {
                oll[i] = ' '; // Replace newline with space
            }
        }
    ...
    if (pll)
    {
        ...
        for (int i = 0; pll[i] != '\0'; ++i)
        {
            if ((pll[i] == '\n') || (pll[i] == ')') || (pll[i] == '('))
            {
                pll[i] = ' '; // Replace newline with space
            }
        }
